...
module.exports = {
    obtenerSeguimiento(idPaciente){
        return new Promise ((resolve, reject) =>{
            conexion.query('SELECT seguimiento.fecha, seguimiento.motivo, seguimiento.peso, seguimiento.talla, seguimiento.imc, imc.status, resultado.prescripcion FROM seguimiento INNER JOIN paciente ON seguimiento.paciente_id = paciente.id INNER JOIN imc ON imc.id = seguimiento.imc_id INNER JOIN resultado ON resultado.seguimiento_id = seguimiento.id WHERE seguimiento.paciente_id = ?',
